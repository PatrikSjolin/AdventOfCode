    ...
    class Program
    {
        ...
        private static Dictionary<int, string> GetSolutions(int year)
        {
            ...
            if(year == 2020)
            {
                return new Dictionary<int, string>
                {
                    ...
                    { 11, "2441;2190" },
                    { 12, "1186;47806" },
                    { 13, "138;226845233210288" },
                    { 14, "14722016054794;3618217244644" },
                    { 15, "614;1065" },
                    { 16, "28873;2587271823407" },
                    { 17, "348;2236" },
                    { 18, ";" },
                    { 19, ";" },
                    { 20, ";" },
        ...
        private static Dictionary<int, IPuzzle> GetPuzzles(int year)
        {
            ...
            if(year == 2022)
            {
                return new Dictionary<int, IPuzzle>
                {
                    { 1, new Days_2022.Day01() },
                    { 2, new Days_2022.Day02() },
                    { 3, new Days_2022.Day03() },
                    { 4, new Days_2022.Day04() },
                    { 5, new Days_2022.Day05() },
                    { 6, new Days_2022.Day06() },
                    { 7, new Days_2022.Day07() },
                    //{ 8, new Days_2021.Day08() },
                    //{ 9, new Days_2020.Day09() },
                    //{ 10, new Days_2020.Day10() },
                    //{ 11, new Days_2020.Day11() },
            ...
            if (year == 2023)
            {
                return new Dictionary<int, IPuzzle>
                {
                    { 1, new Days_2023.Day01() },
                    { 2, new Days_2023.Day02() },
                    { 3, new Days_2023.Day03() },
                    { 4, new Days_2023.Day04() },
                    //{ 5, new Days_2022.Day05() },
                    //{ 6, new Days_2022.Day06() },
                    //{ 7, new Days_2022.Day07() },
                    //{ 8, new Days_2021.Day08() },
